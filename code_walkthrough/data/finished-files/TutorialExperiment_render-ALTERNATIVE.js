(function () {
    var app = angular.module('TutorialExperimentApp', ["Lingoturk"]);
    ...
    app.controller('RenderController', ['$http', '$timeout', '$scope', function ($http, $timeout, $scope) {
        ...
        this.submitResults = function (successCallback, errorCallback) {
            var results = {
                experimentType : "TutorialExperiment",
        ...
        this.nextQuestion = function(){
            self.questions[self.questionIndex]["answer"]["textBoxEntry"] = document.getElementById('altNameInput').value
